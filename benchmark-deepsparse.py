...
def benchmark_pipeline(compiled_model, data, batch_size=1, iterations=100, img_sz=640):
    original_shape = None
    if len(data.shape) == 3:
...
if __name__ == '__main__':
    ...
    if args.do_pipeline:
        ...
        if args.images_path is not None:
            _ = benchmark_pipeline(compiled_model, np_imgs, args.batch_size, args.iterations)
        elif args.big_image:
